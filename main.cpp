...
bool IsCollision(const Segment& segment, const Plane& plane) {
	...
	Novice::ScreenPrintf(20, 20, "t:%f", t);
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		worldViewProjectionMatrix = MultiplyMat4(worldMatrix, MultiplyMat4(viewMatrix, viewProjectionMatrix));
		ImGui::End();
		...
		Novice::ScreenPrintf(0,0,"o:%f,b:%f,d:%f,n:%f", segment.origin.x,segment.diff.x, plane.distance,plane.normal.x);
